...
export default function SingleBlogPage() {
  ...
  const fetchBlog = async () => {
    try {
      ...
      const res = await axios.get(
        `https://blogsy-vmxj.onrender.com/api/blogs/${id}`,
        config
      );
      setBlog(res.data);
  ...
  const checkFollowStatus = async (authorId) => {
    try {
      ...
      const res = await axios.get(`https://blogsy-vmxj.onrender.com/api/users/${authorId}/follow-status`, config);
  ...
  const confirmDelete = async () => {
    try {
      ...
      await axios.delete(`https://blogsy-vmxj.onrender.com/api/blogs/${id}`, config);
  ...
  const handleCommentSubmit = async (e) => {
    ...
    try {
      ...
      const res = await axios.post(
        `https://blogsy-vmxj.onrender.com/api/blogs/${id}/comment`,
        { comment },
        config
      );
      setBlog((prev) => ({
  ...
  const handleLikeToggle = async () => {
    ...
    try {
      ...
      const res = await axios.put(`https://blogsy-vmxj.onrender.com/api/blogs/${id}/like`, {}, config);
  ...
  const handleFavoriteToggle = async () => {
    ...
    try {
      ...
      const res = await axios.put(`https://blogsy-vmxj.onrender.com/api/users/favourites/${id}`, {}, config);
  ...
  const handleFollowToggle = async () => {
    ...
    try {
      ...
      const res = await axios.put(`https://blogsy-vmxj.onrender.com/api/users/${endpoint}/${blog.author._id}`, {}, config);
