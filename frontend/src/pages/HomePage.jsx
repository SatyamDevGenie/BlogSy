    ...
    <>
      ...
      <section className="text-center py-8 px-4 sm:py-10 md:py-16 shadow-inner">
        ...
        <p className="text-sm sm:text-base text-gray-600 max-w-xl mx-auto leading-relaxed animate-fade-in delay-150">
          ...
          from our writing community blogs.
        </p>
      </section>

      {/* Action Buttons */}
      <div className="flex flex-col sm:flex-row sm:justify-center items-center gap-4 px-4 py-6 sm:py-8">
        <Link
          to="/trending"
          className="group w-full sm:w-auto flex justify-center items-center gap-2 px-5 py-2.5 rounded-full text-white bg-gradient-to-r from-purple-500 via-pink-500 to-red-500 shadow-lg transition-all duration-300 hover:from-purple-600 hover:to-red-600 active:scale-95"
        >
        ...
        <Link
          to="/createBlog"
          className="group w-full sm:w-auto flex justify-center items-center gap-2 px-5 py-2.5 rounded-full text-white bg-gradient-to-r from-blue-600 to-cyan-500 shadow-lg transition-all duration-300 hover:from-blue-700 hover:to-cyan-600 active:scale-95"
        >
      ...
      {/* Blog Grid */}
      <div className="px-4 sm:px-6 md:px-8 py-10 mt-3 min-h-[60vh]">
        {isLoading ? (
